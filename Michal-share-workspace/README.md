# Michal — AI Operations Pilot

AI-consulting engagement: build and implement Michal's AI "operating system" on **Gemini**
(Gemini Advanced + Gems + extensions) for her daily coaching operations. First live client
for the AI Audit Toolkit.

> **Privacy is the red line.** No client PII ever enters Gemini or this repo. Aliases in,
> real names re-attached offline by Michal at send time. See `gems/privacy-preamble.md`.
...
| [`MICHAL-AI-OS-V2-EXECUTION-GUIDE.md`](MICHAL-AI-OS-V2-EXECUTION-GUIDE.md) | Hebrew execution guide for Antigravity, NotebookLM advisors, daily routines, plugins, and Obsidian |
| [`notebooklm-advisors/`](notebooklm-advisors/) | Hebrew system prompts for STORM, ADVISOR, and RED TEAM notebooks |
| [`OBSIDIAN-VAULT-WIKI-PLAN.md`](OBSIDIAN-VAULT-WIKI-PLAN.md) | Hebrew plan for the future Obsidian Vault and internal wiki |
